...
#define MPU6050_DEV_ADDR        	( 0x68 )	// MPU6050 IIC设备地址


/* MPU6050 command */
#define MPU6050_WRITE_CMD       	( 0x00 )	// 写命令
#define MPU6050_READ_CMD        	( 0x01 )	// 读命令
#define MPU6050_RESET_CMD			( 0x08 )	// 复位命令
#define MPU6050_REVIVE_CMD			( 0x00 )	// 唤醒命令
