...
/**************************************************************************/
UNS16 Slave_FuncCode_F0[] =		/* Mapped at index 0x20F0, subindex 0x01 - 0x18 */
  {
    0x0,	/* 0 */
    0x0,	/* 0 */
    0x0,	/* 0 */
...
/* index 0x20F0 :   Mapped variable Slave_FuncCode_F0 */
                    UNS8 TestSlave_highestSubIndex_obj20F0 = 24; /* number of subindex - 1*/
                    ODCallback_t Slave_FuncCode_F0_callbacks[] = 
                     {
                       NULL,
                       NULL,
                       NULL,
                    ...
                    subindex TestSlave_Index20F0[] = 
                     {
                       { RO, uint8, sizeof (UNS8), (void*)&TestSlave_highestSubIndex_obj20F0 },
                       { RW, uint16, sizeof (UNS16), (void*)&Slave_FuncCode_F0[0] },
                       { RW, uint16, sizeof (UNS16), (void*)&Slave_FuncCode_F0[1] },
                       { RW, uint16, sizeof (UNS16), (void*)&Slave_FuncCode_F0[2] },
                       { RW, uint16, sizeof (UNS16), (void*)&Slave_FuncCode_F0[3] },
                       { RW, uint16, sizeof (UNS16), (void*)&Slave_FuncCode_F0[4] },
                       { RW, uint16, sizeof (UNS16), (void*)&Slave_FuncCode_F0[5] },
                       { RW, uint16, sizeof (UNS16), (void*)&Slave_FuncCode_F0[6] },
                       { RW, uint16, sizeof (UNS16), (void*)&Slave_FuncCode_F0[7] },
                       { RW, uint16, sizeof (UNS16), (void*)&Slave_FuncCode_F0[8] },
                       { RW, uint16, sizeof (UNS16), (void*)&Slave_FuncCode_F0[9] },
                       { RW, uint16, sizeof (UNS16), (void*)&Slave_FuncCode_F0[10] },
                       { RW, uint16, sizeof (UNS16), (void*)&Slave_FuncCode_F0[11] },
                       { RW, uint16, sizeof (UNS16), (void*)&Slave_FuncCode_F0[12] },
                       { RW, uint16, sizeof (UNS16), (void*)&Slave_FuncCode_F0[13] },
                       { RW, uint16, sizeof (UNS16), (void*)&Slave_FuncCode_F0[14] },
                       { RW, uint16, sizeof (UNS16), (void*)&Slave_FuncCode_F0[15] },
                       { RW, uint16, sizeof (UNS16), (void*)&Slave_FuncCode_F0[16] },
                       { RW, uint16, sizeof (UNS16), (void*)&Slave_FuncCode_F0[17] },
                       { RW, uint16, sizeof (UNS16), (void*)&Slave_FuncCode_F0[18] },
                       { RW, uint16, sizeof (UNS16), (void*)&Slave_FuncCode_F0[19] },
                       { RW, uint16, sizeof (UNS16), (void*)&Slave_FuncCode_F0[20] },
                       { RW, uint16, sizeof (UNS16), (void*)&Slave_FuncCode_F0[21] },
                       { RW, uint16, sizeof (UNS16), (void*)&Slave_FuncCode_F0[22] },
                       { RW, uint16, sizeof (UNS16), (void*)&Slave_FuncCode_F0[23] }
                     };
...
const indextable TestSlave_objdict[] = 
{
  ...
  { (subindex*)TestSlave_Index20F0,sizeof(TestSlave_Index20F0)/sizeof(TestSlave_Index20F0[0]), 0x20F0},
};
...
const indextable * TestSlave_scanIndexOD (UNS16 wIndex, UNS32 * errorCode, ODCallback_t **callbacks)
{
	...
	*callbacks = NULL;
	switch(wIndex){
		...
		case 0x1804: i = 16;*callbacks = TestSlave_Index1804_callbacks; break;
		case 0x1A00: i = 17;break;
		case 0x1A01: i = 18;break;
		case 0x1A02: i = 19;break;
		case 0x1A03: i = 20;break;
		case 0x1A04: i = 21;break;
		case 0x20F0: i = 22;*callbacks = Slave_FuncCode_F0_callbacks; break;
		default:
